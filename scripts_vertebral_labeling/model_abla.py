...
class ModelCountception_v2(nn.Module):
    def __init__(self, inplanes=3, outplanes=1, use_logits=False, logits_per_output=12, debug=False):
        ...
        self.simple1 = SimpleBlock(1, 16, 16, activation=self.activation)
        self.simple2 = SimpleBlock(48, 16, 32, activation=self.activation)
        self.conv2 = ConvBlock(80, 16, ksize=14,pad=22, activation=self.activation)
        ...
        if use_logits:
            ...
            self.conv6 = ConvBlock(32, self.outplanes, ksize=20,pad=18,activation=self.final_activation)
